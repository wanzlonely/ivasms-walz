...
def send_menu(message):
    ...
    bot.send_message(message.chat.id, caption, parse_mode="HTML", reply_markup=generate_keyboard(live_sms_storage), disable_web_page_preview=True)

@bot.callback_query_handler(func=lambda call: True)
def handle_callback(call):
    if call.data == "refresh":
        bot.answer_callback_query(call.id, "Refreshing...")
        bot.edit_message_reply_markup(call.message.chat.id, call.message.message_id, reply_markup=generate_keyboard(live_sms_storage))
